 ...
 * ```
 */
export const MMSInitialProbability = (
  lambda: number = 0,
  mu: number = 1,
  serverSize: number = 1,
  decimals: number = 4,
 ...
 * ```
 */
export const MMSSystemTimeProbability = (
  time: number = 0,
  lambda: number = 1,
  mu: number = 1,
  serverSize: number = 1,
 ...
 * ```
 */
export const MMSProbabilityZeroQueueTime = (
  lambda: number = 0,
  mu: number = 1,
  serverSize: number = 1,
  decimals: number = 4,
 ...
 * ```
 */
export const MMSProbabilityQueueTime = (
  time: number = 0,
  lambda: number = 0,
  mu: number = 1,
  serverSize: number = 1,
