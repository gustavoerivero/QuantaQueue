...
export const MMSKInitialProbability = (lambda: number = 0, mu: number = 1, serverSize: number = 1, limit: number = 1, decimals: number = 4): number => {
...
export const MMSKNProbability = (lambda: number = 0, mu: number = 1, serverSize: number = 1, iteration: number = 1, limit: number = 1, decimals: number = 4): number => {
...
export const MMSKQClientEx = (lambda: number = 0, mu: number = 1, serverSize: number = 1, limit: number = 1, decimals: number = 4): number => {
...
export const MMSKSClientEx = (lambda: number = 0, mu: number = 1, serverSize: number = 1, limit: number = 1, decimals: number = 4): number => {
 ...
 * ```
 */
export const MMSKQTimeEx = (lambda: number = 0, mu: number = 1, serverSize: number = 1, limit: number = 1, decimals: number = 4): number => {
